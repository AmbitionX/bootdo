define("appmsg/appmsgext.js",["appmsg/log.js","biz_wap/utils/ajax.js","rt/appmsg/getappmsgext.rt.js"],function(e){
    ...
    return'<span class="original_img_wrp">            \n    <span class="tips_global">鏉ヨ嚜: <#=source_nickname#></span>\n</span>    ';
    ...
    var i={
        0:{
            90041:"姝ゆ爣棰樺寘鍚じ澶ц瀵间俊鎭�",
            20012:"姝ゆ爣棰樺寘鍚綆淇楁伓淇楀唴瀹�"
        },
        1:{
            90041:"",
            20012:""
        ...
        2:{
            90041:"姝ゆ枃绔犲寘鍚じ澶ц瀵间俊鎭�",
            20012:"姝ゆ枃绔犲寘鍚綆淇楁伓淇楀唴瀹�"
        }
    },s={
        0:{
            90041:"鏍囬浣跨敤澶稿ぇ銆佺吔鍔ㄣ€佷綆淇楃瓑璇嶈閫犳垚璇鎴栧紩浜轰笉閫�",
            20012:"鏍囬浣跨敤浣庝織鎴栨伓淇楄瘝璇€犳垚涓嶆褰撳奖鍝嶆垨寮曚汉涓嶉€�"
        },
        1:{
            90041:"鎽樿鍖呭惈璇銆佺吔鍔ㄧ殑淇℃伅寮曚汉涓嶉€傛垨閫犳垚寰俊鐢ㄦ埛娣锋穯",
            20012:"鎽樿鍖呭惈浣庝織鎴栨伓淇楀唴瀹归€犳垚涓嶆褰撳奖鍝嶆垨寮曚汉涓嶉€�"
        },
        2:{
            90041:"鏂囩珷鍖呭惈璇銆佺吔鍔ㄧ殑淇℃伅寮曚汉涓嶉€傛垨閫犳垚寰俊鐢ㄦ埛娣锋穯",
            20012:"鏂囩珷鍖呭惈浣庝織鎴栨伓淇楀唴瀹归€犳垚涓嶆褰撳奖鍝嶆垨寮曚汉涓嶉€�"
        }
    };
    return{
        maliciousTitleMap:i,
...
define("a/a_utils.js",["biz_wap/jsapi/core.js","biz_wap/utils/ajax.js","biz_wap/utils/mmversion.js","biz_common/utils/report.js","biz_common/dom/class.js","biz_common/utils/url/parse.js","biz_wap/utils/openUrl.js"],function(e){
    ...
    function handleAdWithFrame(e){
        if(e.length){
            ...
            e.forEach(function(e){
                a[e.aid]={
                    aInfo:e
                },console.log("骞垮憡 "+e.aid+"浣跨敤浜嗘柊鐨刬frame缁勪欢娓叉煋妯″紡"),e.pos_type===AD_POS.POS_MID&&(initMidAd(e,t,a),
                    t++);
            }),bindAdEvent(a);
        }
    }
    ...
    function afterGetAdData(e,a){
        ...
        function i(e){
            ...
            if(e.product_type===AD_TYPE.ANDROID_APP_PRODUCT_TYPE||e.product_type===AD_TYPE.IOS_APP_PRODUCT_TYPE){
                var i=t.app_info.app_size||0,_=t.app_info.app_name||t.app_info.appname||"",n=t.app_info.apk_url||t.app_info.pkgurl||"",p=t.app_info.file_md5||t.app_info.pkgmd5||t.app_info.app_md5||"",o=t.app_info.apk_name||t.app_info.pkg_name||"",r=t.app_info.category,d=["涓�","鐧句竾","浜�"],s=t.app_info.down_count||0;
                if(s>=1e4){
                    s/=1e4;
                    for(var l=0;s>=10&&2>l;)s/=100,l++;
                    s=s.toFixed(1)+d[l]+"娆�";
                }else s=s.toFixed(1)+"娆�";
                return r=r?r[0]||"鍏朵粬":"鍏朵粬",i=utils.formSize(i),_=utils.formName(_),t.app_info._down_count=s,
            ...
            for(var m=0;s>m;++m){
                ...
                if(2==g.use_new_protocol&&g.pos_type==AD_POS.POS_BOTTOM){
                    ...
                    CrtManager.CRT_CONF[g.crt_size]||(g.use_new_protocol=g.product_type!=AD_TYPE.IOS_APP_PRODUCT_TYPE&&g.product_type!=AD_TYPE.ANDROID_APP_PRODUCT_TYPE||2!=g.material_type&&9!=g.material_type||g.dest_type!=AD_CONFIG.AD_DEST_TYPE.APPDETAIL_DEST_TYPE&&g.dest_type!=AD_CONFIG.AD_DEST_TYPE.APPINFO_PAGE_DEST_TYPE&&!AD_CONFIG.AD_DEST_TYPE.CANVAS_AD_DEST_TYPE?0:1,
                        console.info("[搴曢儴骞垮憡鏃у崗璁吋瀹筣 crt_size:",g.crt_size," 鏈€缁堝崗璁被鍨嬶細",g.use_new_protocol),ajax({
                ...
                if(urlParser.getQuery("oldAd")&&(g.use_new_protocol=0),u=g.use_new_protocol,_[D]||(_[D]=0),
                    ...
                    var w=g.app_info.down_count||0,x=g.app_info.app_size||0,O=g.app_info.app_name||"",I=g.app_info.category,C=["涓�","鐧句竾","浜�"];
                    if(w>=1e4){
                        w/=1e4;
                        for(var S=0;w>=10&&2>S;)w/=100,S++;
                        w=w.toFixed(1)+C[S]+"娆�";
                    }else w=w.toFixed(1)+"娆�";
                    x=utils.formSize(x),I=I?I[0]||"鍏朵粬":"鍏朵粬",O=utils.formName(O),g.app_info._down_count=w,
            ...
            for(var B in q)if(0===B.indexOf("pos_")){
                ...
                if(f&&g){
                    if(insertAutoAdElement(g),2!==g.use_new_protocol){
                        if(0==g.pos_type){
                            if(g.new_appmsg=window.new_appmsg,g.longAppBtnText=P===AD_TYPE.IOS_APP_PRODUCT_TYPE?"鏌ョ湅搴旂敤":"涓嬭浇搴旂敤",
                                g.shortAppBtnText=P===AD_TYPE.IOS_APP_PRODUCT_TYPE?"鏌ョ湅":"涓嬭浇",js_bottom_ad_area.innerHTML=TMPL.tmpl(a_tpl,g),
                        ...
                        mmversion.isIOS&&g.app_info&&g.app_info.url_scheme&&P===AD_TYPE.IOS_APP_PRODUCT_TYPE&&(document.getElementById("js_promotion_tag")&&(document.getElementById("js_promotion_tag").innerHTML="鏌ョ湅搴旂敤"),
                        document.getElementsByClassName("js_ad_btn")&&document.getElementsByClassName("js_ad_btn").length>0&&(document.getElementsByClassName("js_ad_btn")[0].innerHTML="鏌ョ湅"),
                        document.getElementById("js_ad_btn_"+g.pos_type)&&(document.getElementById("js_ad_btn_"+g.pos_type).innerHTML="鏌ョ湅搴旂敤"));
                    }else{
                        var J,X={},G=!1,Q={};
                        if(g.button_action)try{
                            "string"==typeof g.button_action&&(g.button_action=JSON.parse(g.button_action.html())),
                            g.button_action.button_text&&""!=g.button_action.button_text||(g.button_action.button_text="鍘婚€涢€�");
                        }catch(Y){
                            g.button_action={
                        ...
                        g.pos_type===AD_POS.POS_MID){
                            ...
                            if(g.video_info&&(f.displayWidth=g.video_info.displayWidth,f.displayHeight=g.video_info.displayHeight,
                                ...
                                JSAPI.invoke("getInstallState",{
                                    ...
                                    i.indexOf("get_install_state:yes")>-1&&g.app_info.url_scheme&&(_.textContent=354==parseInt(a.crt_size)||117==parseInt(a.crt_size)||355==parseInt(a.crt_size)||568==parseInt(a.crt_size)?"杩涘叆":"杩涘叆搴旂敤");
                                });
                            }),X=utils.extend({
                                banner:g.image_url,
                                is_wx_app:g.button_action.jump_type==AD_CONFIG.AD_DEST_TYPE.WECHAT_APPLET_DEST_TYPE,
    ...
    function _parseExpCpc(e){
        ...
        if(5==e.watermark_type&&(t.btn_text="鏌ョ湅璇︽儏"),29===a||31===a?t.btn_text="鏌ョ湅璇︽儏":a===AD_TYPE.ANDROID_APP_PRODUCT_TYPE||a===AD_TYPE.IOS_APP_PRODUCT_TYPE?t.btn_text=a===AD_TYPE.IOS_APP_PRODUCT_TYPE?"鏌ョ湅搴旂敤":"涓嬭浇搴旂敤":30===a?t.btn_text="鍘婚€涢€�":a===AD_TYPE.ADD_CONTACT_PRODUCT_TYPE?t.btn_text=e.biz_info.is_subscribed?"鏌ョ湅鍏紬鍙�":"鍏虫敞鍏紬鍙�":a===AD_TYPE.MINI_GAME_PRODUCT_TYPE&&(t.btn_text="杩涘叆灏忔父鎴�"),
        e.dest_type===AD_CONFIG.AD_DEST_TYPE.CANVAS_AD_DEST_TYPE&&(t.btn_text="鏌ョ湅璇︽儏"),e.cpc_exp_info&&e.cpc_exp_info.exp_content){
        ...
        if(!has_click[_]){
            ...
            l&&l.weapp_info&&l.weapp_info.original_id&&(b=l.weapp_info.original_id),AdClickReport({
                ...
                if(D)if(g.dest_type===AD_CONFIG.AD_DEST_TYPE.OUTER_DEST_TYPE)handleH5(a,_,idx,mid,biz,r,o,s,d,l,g);else if(g.dest_type===AD_CONFIG.AD_DEST_TYPE.WECHAT_APPLET_DEST_TYPE)Wxopen_card.openWxopen(l);else if(g.dest_type===AD_CONFIG.AD_DEST_TYPE.AD_DEST_TYPE)openUrlWithExtraWebview(a);else{
                    ...
                    console.info("[骞垮憡鏂板崗璁厹搴曡烦杞琞",g),openUrlWithExtraWebview(a);
                    ...
                    if(m.length>0&&(n=p.tid||o.traceid,_=o.aid,DomEvent.on(m[0],"click",function(e){
                        ...
                        new g({
                            ...
                            percentStatus:function(a,t){
                                ...
                                i.percent=t,"downloading"==a?i.btn_text="鏆傚仠":"paused"==a?i.btn_text="缁х画":"installed"==a?(i.percent=0,
                                    i.btn_text="宸插畨瑁�"):"downloaded"==a?(i.percent=0,i.btn_text="瀹夎"):"gotodetail"==a?(i.percent=0,
                                    i.btn_text=117==parseInt(o.crt_size)||354==parseInt(o.crt_size)||355==parseInt(o.crt_size)||568==parseInt(o.crt_size)?"杩涘叆":"杩涘叆搴旂敤"):(i.percent=0,
                                    i.btn_text=117==parseInt(o.crt_size)||354==parseInt(o.crt_size)||355==parseInt(o.crt_size)||568==parseInt(o.crt_size)?"杩涘叆":"杩涘叆搴旂敤"),
                        ...
                        if(console.info("[骞垮憡鏂板崗璁偣鍑荤礌鏉怾",o.dest_type,o.product_type),p){
                            p.adid=window.adid||p.adid||p.aid;
    ...
    function handleH5(e,a,t,i,_,n,p,o,r,d,s){
        if(console.info("[骞垮憡澶勭悊H5浜嬩欢]",s),-1==e.indexOf("mp.weixin.qq.com"))e="http://mp.weixinbridge.com/mp/wapredirect?url="+encodeURIComponent(e);else if(-1==e.indexOf("mp.weixin.qq.com/s")&&-1==e.indexOf("mp.weixin.qq.com/mp/appmsg/show")){
            var l={
                source:4,
                tid:a,
                idx:t,
        ...
        console.info("[骞垮憡H5钀藉湴椤垫渶缁圲RL]",e),openUrlWithExtraWebview(e);
    }
