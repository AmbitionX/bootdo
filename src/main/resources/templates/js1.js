define("appmsg/review_image.js", ["biz_common/dom/event.js", "biz_wap/jsapi/core.js", "biz_common/utils/url/parse.js", "appmsg/log.js", "biz_wap/utils/ajax.js", "biz_wap/utils/mmversion.js", "appmsg/cdn_img_lib.js"], function (e) {
                        ...
                        if (!(i && i.target && i.target.className && i.target.className.indexOf("img_loadederror") > -1)) {
                            if ("function" == typeof window.__addIdKeyReport && window.__addIdKeyReport("110644", 2),
                                ...
                                for (var r = i.target, n = r.getBoundingClientRect(), d = !0; r && "body" != r.nodeName.toLowerCase();) {
                                    var s = window.getComputedStyle(r, null),
                                        g = parseInt(s.getPropertyValue("opacity")), l = s.getPropertyValue("filter"),
                                        u = s.getPropertyValue("visibility"), w = s.mixBlendMode;
                                ...
                                if (!d) {
                                    if (console.log("don't try this again"), "function" == typeof window.__addIdKeyReport) {
                                        ...
                                        var f = new Image,
                                            b = "https://badjs.weixinbridge.com/badjs?id=168&level=4&from=" + encodeURIComponent(location.href) + "&msg=" + encodeURIComponent(e);
                            ...
                            var y = i.target, _ = window.getComputedStyle(y), v = y.getBoundingClientRect(),
    ...
    var i = e("biz_common/dom/event.js"), r = e("biz_wap/jsapi/core.js"), n = e("biz_common/utils/url/parse.js"),
        d = e("appmsg/log.js"), s = e("biz_wap/utils/ajax.js"), p = e("biz_wap/utils/mmversion.js"), g = !1;
...
define("appmsg/async.js", ["biz_common/utils/string/html.js", "appmsg/comment_utils.js", "pages/create_txv.js", "pages/video_ctrl.js", "biz_common/utils/url/parse.js", "biz_common/dom/class.js", "appmsg/img_copyright_tpl.html.js", "appmsg/appmsgext.js", "appmsg/share_tpl.html.js", "biz_common/dom/event.js", "biz_wap/utils/ajax.js", "biz_wap/jsapi/core.js", "biz_common/tmpl.js", "biz_wap/utils/storage.js", "appmsg/log.js", "rt/appmsg/getappmsgext.rt.js", "a/a_utils.js", "biz_wap/utils/mmversion.js", "pages/version4video.js", "appmsg/like.js", "appmsg/reward_entry.js", "appmsg/iframe.js", "appmsg/more_read.js"], function (e, t, r, i) {
    ...
    function a(e) {
        var t = e.getAttribute("data-src") || e.getAttribute("src"), r = g.getQuery("vid", t),
            i = e.getAttribute("data-vw"), n = e.getAttribute("data-vh"), a = e.getAttribute("data-ratio"),
    ...
    function _(t) {
        ...
        if (window.appmsgstat || (window.appmsgstat = r), r.show) {
            {
                var n = document.getElementById("js_read_area3"), a = document.getElementById("like3"),
                    d = document.getElementById("like_old"), o = document.getElementById("likeNum3"),
                    _ = document.getElementById("likeNum_old"), s = document.getElementById("readNum3");
    ...
    var c, p = e("appmsg/comment_utils.js"), w = e("pages/create_txv.js"), u = e("pages/video_ctrl.js"),
        g = e("biz_common/utils/url/parse.js"), h = (e("biz_common/dom/class.js"),
            e("appmsg/img_copyright_tpl.html.js")), y = e("appmsg/appmsgext.js"), v = e("appmsg/share_tpl.html.js"),
        f = navigator.userAgent, b = -1 != f.indexOf("MicroMessenger"),
        ...
        x = e("biz_wap/jsapi/core.js"), I = e("biz_common/tmpl.js"), E = (e("biz_wap/utils/storage.js"),
            e("appmsg/log.js")), B = (e("rt/appmsg/getappmsgext.rt.js"), e("a/a_utils.js")),
        z = e("biz_wap/utils/mmversion.js"), A = [];
    n(), s();
});
...
define("biz_wap/ui/lazyload_img.js", ["biz_wap/utils/mmversion.js", "biz_common/dom/event.js", "biz_common/dom/attr.js", "biz_common/ui/imgonepx.js"], function (t) {
    ...
    function i() {
        ...
        var i = window.pageYOffset || document.documentElement.scrollTop,
            e = window.innerHeight || document.documentElement.clientHeight, o = this.offset || 60, n = 0;
    ...
    function e() {
        var t = document.getElementsByTagName("img"), e = [], o = this.container, n = this.attrKey || "data-src",
            a = o.offsetWidth, s = 0, r = this.imgOccupied || !1, l = this.crossOrigin || !1;
    ...
    var a = t("biz_wap/utils/mmversion.js"), s = t("biz_common/dom/event.js"), r = t("biz_common/dom/attr.js"),
        m = r.attr, h = r.setProperty, c = t("biz_common/ui/imgonepx.js"), l = !0;
    return n;
});
...
define("appmsg/share.js", ["biz_common/utils/string/html.js", "appmsg/cdn_img_lib.js", "biz_common/dom/event.js", "biz_common/utils/url/parse.js", "biz_wap/utils/mmversion.js", "appmsg/appmsg_report.js", "appmsg/malicious_wording.js", "biz_wap/utils/ajax.js", "biz_wap/jsapi/core.js"], function (e) {
    ...
    var o = (e("biz_common/dom/event.js"), e("biz_common/utils/url/parse.js")), s = e("biz_wap/utils/mmversion.js"),
        m = e("appmsg/appmsg_report.js"), a = e("appmsg/malicious_wording.js"), c = (e("biz_wap/utils/ajax.js"),
            e("biz_wap/jsapi/core.js"));
    c.call("hideToolbar"), c.call("showOptionMenu");
    var l = msg_title.htmlDecode(), r = (msg_source_url.htmlDecode(), ""),
        _ = cdn_url_1_1 || msg_cdn_url || ori_head_img_url || round_head_img, u = _, p = msg_link.htmlDecode(),
        l = msg_title.htmlDecode(), g = msg_desc.htmlDecode();
...
define("appmsg/finance_communicate.js", [], function () {
    ...
    var n = document.getElementById("js_content"), o = document.getElementById("img-content"),
        a = document.getElementById("js_article"), s = document.getElementsByClassName("rich_media_area_extra")[0];
...
define("a/mpAdAsync.js", ["appmsg/log.js", "biz_wap/utils/ajax.js", "rt/appmsg/getappmsgext.rt.js", "a/a.js", "a/a_utils.js"], function (e) {
    ...
    function t(e, t, d) {
        var p = [], g = m.checkNeedAds(), w = g.is_need_ad, l = g.both_ad, f = i("mock"), v = i("rtx"),
            _ = "/mockserver/mockservercgi-bin/offerTestCase/mmbizwap/mp/getappmsgad", y = "/mp/getappmsgad";
        t = t || {}, e || (e = []);
        ...
        (f && "-1" != f || v) && (console.info("[广告走mock系统] mockId", f, "rtx", v), y = _), console.info("[广告发送请求] 是否拉取广告", w),
            s({
                ...
                success: function (e) {
                    ...
                    } else o("[Appmsg] success get async ad data, async data is empty"), a(p);
                    d && d();
                },
                error: function () {
...
define("biz_common/utils/url/parse.js", [], function () {
    ...
    function t(r) {
        var e = arguments[1] || window.location.search, n = new RegExp("(^|&)" + r + "=([^&]*)(&|$)"),
            t = e.substr(e.indexOf("?") + 1).match(n);
        return null != t ? t[2] : "";
    }
...
define("appmsg/appmsg_report.js", ["biz_wap/utils/ajax.js", "pages/video_communicate_adaptor.js"], function (i) {
    ...
    function o(i) {
        ...
        if (e = e.split("#").shift(), "" != e) {
            var p = i.reportVid || window.reportVid, d = i.reportMid || window.reportMid,
                r = i.reportVoiceid || window.reportVoiceid, a = i.reportWeappid || window.reportWeappid, w = [],
                _ = [], u = [];
...
define("biz_common/moment.js", [], function (t, e, n) {
    ...
    function Le(t) {
        var e = W(t), n = e.year || 0, i = e.quarter || 0, r = e.month || 0, s = e.week || 0, a = e.day || 0,
    ...
    function Ae(t) {
        var e = (t || "").match(rr) || [], n = e[e.length - 1] || [], i = (n + "").match(br) || ["-", 0, 0],
            r = +(60 * i[1]) + D(i[2]);
        return "+" === i[0] ? r : -r;
    }
    ...
    function an(t, e) {
        var n = t || Ge(), i = ze(n, this).startOf("day"), r = this.diff(i, "days", !0),
    ...
    function Fi(t, e, n) {
        var i = Ke(t).abs(), r = ms(i.as("s")), s = ms(i.as("m")), a = ms(i.as("h")), o = ms(i.as("d")),
            u = ms(i.as("M")), d = ms(i.as("y")),
    ...
    var xi, Ii, Ai = i.momentProperties = [], zi = !1, Zi = {}, ji = {},
        Ei = /(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Q|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g,
        Ni = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, Vi = {}, qi = {}, Ji = /\d/, $i = /\d\d/, Ri = /\d{3}/,
        Bi = /\d{4}/, Qi = /[+-]?\d{6}/, Xi = /\d\d?/, Ki = /\d{1,3}/, tr = /\d{1,4}/, er = /[+-]?\d{1,6}/, nr = /\d+/,
        ir = /[+-]?\d+/, rr = /Z|[+-]\d\d:?\d\d/gi, sr = /[+-]?\d+(\.\d{1,3})?/,
        ar = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,
        or = {}, ur = {}, dr = 0, lr = 1, cr = 2, hr = 3, fr = 4, mr = 5, _r = 6;
    ...
    var yr = "January_February_March_April_May_June_July_August_September_October_November_December".split("_"),
        pr = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), gr = {};
    ...
    var Dr = /^\s*(?:[+-]\d{6}|\d{4})-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,
        ...
        Mr = [["HH:mm:ss.SSSS", /(T| )\d\d:\d\d:\d\d\.\d+/], ["HH:mm:ss", /(T| )\d\d:\d\d:\d\d/], ["HH:mm", /(T| )\d\d:\d\d/], ["HH", /(T| )\d\d/]],
        Yr = /^\/?Date\((\-?\d+)/i;
    ...
    var Or = /(\-)?(?:(\d*)\.)?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?)?/,
        Ur = /^(-)?P(?:(?:([0-9,.]*)Y)?(?:([0-9,.]*)M)?(?:([0-9,.]*)D)?(?:T(?:([0-9,.]*)H)?(?:([0-9,.]*)M)?(?:([0-9,.]*)S)?)?|([0-9,.]*)W)$/;
    Ke.fn = Le.prototype;
    ...
    var Pr = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
        Hr = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), Lr = "Su_Mo_Tu_We_Th_Fr_Sa".split("_");
    ...
    var Xr = Math.abs, Kr = Oi("ms"), ts = Oi("s"), es = Oi("m"), ns = Oi("h"), is = Oi("d"), rs = Oi("w"),
        ss = Oi("M"), as = Oi("y"), os = Wi("milliseconds"), us = Wi("seconds"), ds = Wi("minutes"), ls = Wi("hours"),
        cs = Wi("days"), hs = Wi("months"), fs = Wi("years"), ms = Math.round, _s = {
            s: 45,
            m: 45,
            h: 22,
            d: 26,
