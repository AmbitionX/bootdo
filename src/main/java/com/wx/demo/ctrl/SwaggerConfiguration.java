...
public class SwaggerConfiguration {
    ...
    public Docket defaultApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .groupName("默认接口")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.wx.demo.wechatapi.criterion"))
    ...
    public Docket groupRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .groupName("分组接口")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.wx.demo.wechatapi.distributed"))
                .paths(PathSelectors.any())
    ...
    private ApiInfo groupApiInfo(){
        return new ApiInfoBuilder()
                .title("wxipad™ Api接口文档")
                .description("微信通讯协议 Api 接口文档")
                .termsOfServiceUrl("http://www.wxipad.com/")
